          ...
          <div class="shop--imovel__wrapper">
            <div class="shop--imovel__img col-lg-6">
              <a href="<?php echo $url;?>">
                ...
                <img class="shop--imovel__primary-img" src="<?php echo RemoveHttpS(ConfigPainel('base_url')); ?>wa/imobiliaria/uploads/<?php echo $imovel['id_foto_capa']; ?>" alt="Foto Im車vel <?php echo $imovel['nome']; ?> 1">

                <?php if($segunda_foto){ ?>
                  <!--<img class="shop--imovel__secondary-img" src="<?php echo RemoveHttpS(ConfigPainel('base_url')); ?>wa/imobiliaria/uploads/<?php echo $segunda_foto; ?>" alt="Foto Im車vel <?php echo $imovel['nome']; ?> 2"> -->
                <?php } ?>
              </a>
            </div>
            ...
            <div class="shop--imovel__action" >
              <center>  <a class="btn btn-primary btn-lg btn-block" href="<?php echo $url;?>"><i class="fa fa-eye" aria-hidden="true"></i> Ver o Im車vel</a></center>
             </div>
          </div>
        </div>
      <?php }; }else{ echo "<center class='col-md-8' >Nenhum im車vel encontrado</center>" ;} ?>
    </div>
  </div>
</div>
              ...
              <div class="shop--imovel__rooms"> 
                    ...
                    <i class="fa Ashop--imovel__action" aria-hidden="true"> 
                        <a class="btn btn-primary btn-lg btn-block" href="<?php echo $url;?>">
                            <i class="fa fa-eye" aria-hidden="true"></i> Ver Im車vel
