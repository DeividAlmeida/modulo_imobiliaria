          ...
          <div class="shop--imovel__wrapper">
            ...
            <div class="shop--imovel__content">
              ...
              <div class="shop--imovel__action">
                <a class="btn-see btn btn-primary" href="<?php echo $url;?>">Ver Imóvel</a>
                <a class="btn-buy btn btn-primary" <?php echo (!empty($imovel['link_venda'])) ? "target='{$imovel["target_link"]}' href='{$imovel["link_venda"]}'" : 'onclick="CarrinhoAdd('.$imovel["id"].', '."'{$config["pagina_carrinho"]}'".')"'; ?>>Comprar</a>
              </div>
            </div>
